                        ...
                        <div className="flex mt-2 gap-3 justify-between">
                            ...
                            {pick.account.user_id !== user?.id && (
                                <button
                                    ...
                                    className="px-3 whitespace-nowrap py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Make this pick
                                </button>
                            )}
